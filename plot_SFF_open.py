...
for beta in beta_arr:
    dataList1 = []
    for g in g_arr:
        if not os.path.exists(f"SFF/SFFvsTime,kappa={kappa},j={j},M={M},g={g},beta={beta},ntraj={ntraj}.dat"):
            print("Data file not found. Generating data...")
            runpy.run_path("calc_SFF_open.py", init_globals={'__name__': '__main__'})
            print("Data generation complete.")
        data = np.loadtxt(f"SFF/SFFvsTime,kappa={kappa},j={j},M={M},g={g},beta={beta},ntraj={ntraj}.dat")
